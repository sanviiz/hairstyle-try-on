...
def background_artifact_fill(original_image, original_mask, new_image):
    ...
    filled_background = cv2.inpaint(original_image,
                                    dilation_mask, 25, cv2.INPAINT_TELEA)
...
def face_artifact_fill(original_image, original_mask, new_image,
    ...
    filled_bg_artifact = background_artifact_fill(
        original_image, original_mask, new_image).astype('uint8')
